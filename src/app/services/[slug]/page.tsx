...
export default async function ServicePage({
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Accueil",
        item: "https://eriksitnikov.fr",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Services",
        item: "https://eriksitnikov.fr/services",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: service.title,
        item: `https://eriksitnikov.fr/services/${slug}`,
      },
    ],
  };
  ...
  const faqItems = [
    {
      question: `Ce service est-il adapté à une TPE/PME à Orléans ?`,
      answer:
        "Oui. Chaque prestation est calibrée pour des entreprises locales avec des objectifs concrets: plus d'appels, plus de demandes qualifiées et une meilleure visibilité sur Google.",
    },
    {
      question: "En combien de temps peut-on voir les premiers résultats ?",
      answer:
        "Le délai dépend de la prestation et de votre point de départ, mais des premiers effets sont souvent visibles en quelques semaines sur les indicateurs clés (visibilité, contacts, engagement).",
    },
    {
      question: `Intervenez-vous uniquement sur ${service.title} ?`,
      answer:
        "Non. L'accompagnement peut inclure des actions complémentaires (SEO local, Google Business Profile, optimisation du site) pour maximiser les résultats.",
    },
  ];
    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative overflow-hidden bg-[#FDFCFA] pb-20 pt-32 lg:pb-28 lg:pt-44">
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-14">
          {/* Breadcrumb */}
          <nav
            className="mb-10 flex items-center gap-2 text-xs text-gray-400"
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_auto] lg:gap-20">
            ...
            <div className="max-w-[640px]">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  Tous les services SEO a Orleans
      ...
      {/* ══════════════════════════════════════════════════════════════════
          FULL DESCRIPTION
      ══════════════════════════════════════════════════════════════════ */}
      <section className="relative overflow-hidden bg-gradient-to-b from-white via-[#F8FBFF] to-white py-20 lg:py-28">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -left-24 top-8 h-72 w-72 rounded-full bg-blue-100/60"
          style={{ filter: "blur(70px)" }}
        />
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -right-20 bottom-8 h-80 w-80 rounded-full bg-sky-100/60"
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_1fr] lg:gap-20">
            ...
            <div>
              ...
              <p className="max-w-[400px] text-base leading-relaxed text-gray-500">
                Des résultats mesurables, pas des promesses vagues. Chaque
                bénéfice est directement lié aux actions menées.
              </p>
            </div>
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-14">
          <div className="mx-auto max-w-[600px] text-center">
            ...
            <p className="mb-10 text-base leading-relaxed text-gray-500">
              Un audit gratuit de 10 minutes suffit pour établir un diagnostic
              précis et vous proposer un plan d'action concret.
            </p>
      ...
      <section className="bg-white py-20 lg:py-24">
        <div className="mx-auto max-w-[980px] px-5 sm:px-8 lg:px-14">
          <div className="mb-10">
            <div className="mb-4 flex items-center gap-3">
              <span className="text-xs font-bold uppercase tracking-[0.26em] text-blue-600">
                FAQ
          ...
          <div className="space-y-4">
            {faqItems.map((item) => (
              <article
                key={item.question}
                className="rounded-2xl border border-gray-200/80 bg-[#F8F7F5] px-6 py-5"
              >
